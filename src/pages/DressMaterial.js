...
function DressMaterial() {
  ...
  const fetchbyCategory = async (category) => {
    try {
      let res = await fetch(`${process.env.REACT_APP_PRODUCT_API}/api/dress?nameCategory=${category}`)
  ...
  return (
    <div id="container" className="flex bg-[#faf7f2] h-[100v] w-full">
      <style>
        {`
           .slick-dots li {
              margin-right: -5px; 
      ...
      <div className="bg-[#faf7f2] w-[100%] h-[100vh] sm:ml-[5px] overflow-y-scroll">
        <div className="mx-[8px]">
          <div className="mt-6 grid grid-cols-2 list-none h-[100vh] gap-x-2 sm:gap-x-1 lg:w-[90%] md:px-6 gap-y-2 sm:grid-cols-2 lg:grid-cols-4 xs:grid-cols-2 md:grid-cols-2">
